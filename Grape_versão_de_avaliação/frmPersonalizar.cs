...
namespace Grape_versão_de_avaliação
{
    public partial class frmPersonalizar : Form
    {
        ...
        private void frmPersonalizar_MouseDown(object sender, MouseEventArgs e)
        {
            mouseDown = true;
            lastLocaction = e.Location;
        }

        private void frmPersonalizar_MouseMove(object sender, MouseEventArgs e)
        {
            if (mouseDown)
            {
        ...
        private void frmPersonalizar_MouseUp(object sender, MouseEventArgs e)
        {
            mouseDown = false;
        }
        ...
        {
            frmAbrirArquivos faa = new frmAbrirArquivos();
            faa.Show();
        }
    }
}
