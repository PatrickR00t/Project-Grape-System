...
{
    public partial class frmAbrirArquivos : Form
    {
        public frmAbrirArquivos()
        {
            InitializeComponent();
        }
        bool mouseDown;
        ...
        private void frmAbrirArquivos_MouseDown(object sender, MouseEventArgs e)
        {
            mouseDown = true;
            lastLocaction = e.Location;
        }

        private void frmAbrirArquivos_MouseMove(object sender, MouseEventArgs e)
        {
            if (mouseDown)
            {
        ...
        private void frmAbrirArquivos_MouseUp(object sender, MouseEventArgs e)
        {
            mouseDown = false;
        }
        ...
        private void frmAbrirArquivos_Load(object sender, EventArgs e)
        {
